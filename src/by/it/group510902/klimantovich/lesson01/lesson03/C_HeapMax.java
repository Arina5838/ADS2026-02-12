    ...
    private class MaxHeap {
        ...
        int siftUp(int i) { //просеивание вверх
            while (i>0){
                ...
                //Меняем местами с родителями, если текущий элемент больше
        ...
        Long extractMax() { //извлечение и удаление максимума
            ...
            // Перемешаем последний элемент в корень
            heap.set(0, heap.get(heap.size()-1));
            heap.remove(heap.size()- 1);
            //Восстанавливающий свойство кучи просеиванием вниз
            siftDown(0);
